    ...
    <div class="section dark" id="home">
      <div class="content">
        <div class="center" id="title">
          Hi, my name is<br />
          <span class="emphasis" id="name">Ibtsam Khan</span>.
          <div id="subtitle">
            I'm an undergrad
            <span class="emphasis">IT Student</span>, and an aspiring
      ...
      <div class="content">
        ...
        <div class="text" id="description-group">
          ...
          <div class="round" id="self-object">
            <pre>let <b>Ibtsam</b> = {</pre>
            <pre>  <b>age</b>: 19, <span>//Soon to be 22!</span></pre>
            <pre>  <b>school</b>: 'Bahauddin Zakariya University, Multan',</pre>
            <pre>  <b>program</b>: 'Information Technology',</pre>
            <pre>  <b>favouriteLanguage</b>: 'JavaScript & php',</pre>
            <pre>  <b>currentSemester</b>: 6, <span>//2B - 4th year, 7th semester</span>  </pre>
            <pre>  <b>awaitingSemester</b>: 7, <span>//Completed 6 semesters</span></pre>
      ...
      <div class="content">
        ...
        <div class="flex-group">
          ...
          <div class="text-small flex-item" id="visitor-info">
            ...
            <div>
              <a class='far fa-file-alt' href='/resume/Resume-Ibtsam Ishtiaq.pdf' title=".pdf (0.14 MB)"></a>
